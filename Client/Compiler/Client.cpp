...
HINSTANCE g_hInst;								// 현재 글로벌 인스턴스입니다.
HWND g_hWnd;									// 현재 글로벌 핸들입니다.
					   ...
					   int       nCmdShow)
{
	...
	Engine::CTimeMgr* pTimeMgr = Engine::Get_TimeMgr();
	...
	{
		pTimeMgr->SetTime();			// 시간 갱신
		fTime += pTimeMgr->GetTime();
